...
Generated from **4b0ce3588840 — what the box is serving**, not from the working tree.
...
- — one row per setting, coin and chunk shape, averaging its decision, band and 24/5 variants, which open below as records
