...
Generated from **cf58a662e54e — what the box is serving**, not from the working tree.
...
- — one row per declared setting, averaged over its coin/chunk-shape combinations promoted from Stage 2
- show in 3.B
