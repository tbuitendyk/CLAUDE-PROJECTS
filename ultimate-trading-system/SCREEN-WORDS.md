...
Generated from **97841eed07a9 — what the box is serving**, not from the working tree.
...
- `are already trained and are kept`
- `arm`
- `band % (or auto)`
- `both kinds`
