...
const GUARDS = [
  ...
  [path.join(ROOT, "lib", "live", "targets.js"), "      if (t && t.kind === 'engine' && t.id !== r.id && t.link === 'tunnel' && Number(t.localPort) === r.localPort) problems.push(", "      if (false) problems.push(",
  ...
  [path.join(ROOT, "lib", "live", "enginesetup.js"), "    fs.rmSync(path.join(OLD_KEYS_DIR(), rec.id), { recursive: true, force: true });", "",
    "aTemplateOneChecklistMovesAndItsSignInKeyIsDeleted", "a template 1 checklist's sign-in key is left on this machine"],
  ...
  [path.join(ROOT, "lib", "live", "targets.js"), "  if (was.link === 'tunnel') Object.assign(r, { host:", "  if (true) Object.assign(r, { host:",
    "theEnginesRecordIsTheOwnersAndRefusedInWordsWhenNotWhole", "the form writes a tunnel's ends onto an engine that calls out"],
