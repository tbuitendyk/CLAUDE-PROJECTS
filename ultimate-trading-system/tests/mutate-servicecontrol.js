...
const GUARDS = [
  ...
  [path.join(ROOT, 'lib', 'stages.js'), "      out.holds = holdsOf(records);", "",
    'theTrainingHoldLengthsComeFromTheRecordsOwnChunkShapes',
    'the control has no hold length to fill t with and quietly leaves it on whatever was there'],
  ...
  [path.join(ROOT, 'public', 'construct.js'), "      setV('#swT', String(holds[0]));", "",
    'theTrainingSetupControlFillsTheFormAndStartsNothing',
