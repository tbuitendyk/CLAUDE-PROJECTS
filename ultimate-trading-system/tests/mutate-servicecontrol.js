...
const GUARDS = [
  ...
  [path.join(ROOT, "lib", "live", "enginesetup.js"), "  if (taken) bad(`there is already a setup for an engine called", "  if (false) bad(`there is already a setup for an engine called",
  ...
  [path.join(ROOT, "public", "setup.html"), "(c.clearsNote && ch[c.id] ? '<span class=\"note\">' + esc(c.clearsNote) + '</span>' : '')", "(c.clears && ch[c.id] ? '<span class=\"note\">changing this clears the ticks below: they were about the other machine</span>' : '')",
    "theComputeTabDrawsStepTwo", "step 2's choice shows step 1's note about the other machine"],
  ...
  [path.join(ROOT, "lib", "live", "targets.js"), "  if (!was || was.kind !== 'engine') { const e = new Error(`no engine called ${id || '(none)'}", "  if (was && was.kind !== 'engine') { const e = new Error(`no engine called ${id || '(none)'}",
  ...
  [path.join(ROOT, "lib", "live", "targets.js"), "  if (!LINKS.includes(x.link)) out.push('the link: an engine calls this system');", "",
