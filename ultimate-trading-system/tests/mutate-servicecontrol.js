...
const GUARDS = [
  ...
  [path.join(ROOT, 'lib', 'batch.js'), "  const tHours = raw.tHours === bracketLib.T_OWN ? bracketLib.T_OWN : Number(raw.tHours);",
    "  const tHours = Number(raw.tHours);",
    'theChunksOwnHoldLengthIsResolvedAgainstTheUnitBeingPriced',
    'the validator turns the chunk\'s own into NaN and refuses the one setting the training setup exists to build'],
