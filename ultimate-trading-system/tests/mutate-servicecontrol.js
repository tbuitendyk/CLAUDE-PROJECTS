...
const GUARDS = [
  ...
  [path.join(ROOT, 'public', 'construct.js'), 'const foldBtn = (stage) => putAwayBtn(\'bfold\', stage, fold[stage] && !differs(stage), "this stage\'s table", upEmpty[stage] ? \'disabled class="ctl-off"\' : \'\');',
