...
const GUARDS = [
  ...
  [path.join(ROOT, 'lib', 'stages.js'), "    if (e && e.units && e.units[unitKey]) continue;", "",
    'aKilledPrepPicksUpWhereItStoppedAndAThirdShapeFileMovesToTheFourth', 'every press prices every setting again, so a killed prep starts from nothing'],
