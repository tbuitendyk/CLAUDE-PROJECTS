...
const GUARDS = [
  ...
  [path.join(ROOT, 'public', 'construct.js'), "  const s1Shown = swShownSet(sets, 1, v('#swName1'));", "  const s1Shown = swShownSet(sets, 1, '');",
    'theStageTwoHeadingGoesRedWhenANewerStageOneExists',
    'the stage 1 section stops reading its name box, so two sets copied from Boards can never both read green'],
  [path.join(ROOT, 'public', 'construct.js'), '    if (named) return named;', '',
    'theStageTwoHeadingGoesRedWhenANewerStageOneExists',
    'the name box is read and then ignored — the newest set wins every time'],
