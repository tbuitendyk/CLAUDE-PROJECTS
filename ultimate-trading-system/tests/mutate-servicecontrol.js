...
const GUARDS = [
  ...
  [path.join(ROOT, 'lib', 'fieldbuy.js'), '    const closed = exitPrice != null;', '    const closed = false;',
    'theBuyIsFixedAsPressedAndItsPriceMovesUntilTheExitCandleIsOnFile',
    'a trade whose exit candle is on file keeps reading the newest candle instead of its exit price'],
  [path.join(ROOT, 'lib', 'fieldbuy.js'), '    return { ...r, closed, price, priceTs, movePct, performancePct: movePct == null ? null : movePct * r.sign };', '    return { ...r, closed, price, priceTs, movePct, performancePct: movePct };',
    'theBuyIsFixedAsPressedAndItsPriceMovesUntilTheExitCandleIsOnFile',
    'a fall after a down call reads as a loss'],
