...
const GUARDS = [
  ...
  [path.join(ROOT, 'lib', 'stages.js'), "    delete doc.verify; delete doc.unread; delete doc.others; delete doc.dropped; delete doc.ride;", "    delete doc.others; delete doc.dropped; delete doc.ride;",
