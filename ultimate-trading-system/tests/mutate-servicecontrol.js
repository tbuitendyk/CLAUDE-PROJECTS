...
const GUARDS = [
  ...
  [path.join(ROOT, 'lib', 'stages.js'), "  const heldWindow = ((((parent.windows || {}).units) || {})[doc.unit] || {}).hold || null;", "  const heldWindow = ((((parent.windows || {}).units) || {})[doc.unit] || {}).unread || null;",
    'theRunPricesEveryColumnOnOneStretchAndTheUnweightedColumnIsTheRecordsOwn', 'the table says it was judged on the reserve\'s dates while its money is the held-back window\'s'],
