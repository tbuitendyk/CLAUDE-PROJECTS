...
const GUARDS = [
  ...
  [path.join(ROOT, 'public', 'construct.js'), "/copy`, { name, stops, sizing, ...(sizing && pricedLadder ? { ladder: pricedLadder, pick: tnPickVal } : {}) }, 'The scan target box on Tune lists the sets whose trades are captured.');", "/copy`, { name }, 'The scan target box on Tune lists the sets whose trades are captured.');",
