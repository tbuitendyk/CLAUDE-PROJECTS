...
window.HELP = {
  ...
  coins: {
    ...
    controls: {
      ...
      wScrambles: 'how many copies of the same coin to walk with its outcomes dealt into a new order, leaving every move and every threshold where it was and cutting only the link between what was seen and what followed. With hundreds of rows on the table a handful will shine for nothing, so a row that beats its own copies is saying something and a row that is merely positive is not. Zero skips them and the walk is much faster.',
