#!/usr/bin/env bash
# classifier-l14-seed2.sh -- seed check, run 1 of 2 (owner, 2026-07-31):
# L14's interlaced arm rerun with block-placement seed 2. Everything else
...
curl -sS -X POST http://127.0.0.1:8093/api/bracketlab -H "Content-Type: application/json" -d '{
  ...
  "windowLayout": "interlaced", "interlaceSeed": 2, "sharedBand": true,
  "minTrades": 10,
  "label": "l14-seed2",
  "description": "Seed check 1/2: L14 interlaced arm under block seed 2, reads R1-R4 declared in classifier-l14-seed2.sh before firing."
}'
