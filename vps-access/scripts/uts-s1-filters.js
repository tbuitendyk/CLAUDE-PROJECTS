...
if (!id) { console.log('usage: <setId>'); process.exit(0); }
...
const kept = stages.applyFilters(doc.stage, rows, doc.filters || {});
console.log(`rows: ${rows.length} in all, ${kept.length} pass the saved filters`);
