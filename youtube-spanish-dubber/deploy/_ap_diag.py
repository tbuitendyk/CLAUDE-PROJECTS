"""TEMP: regression check that the redesigned auto-preserve generalises -- render
the OTHER graphics thumbnails (#0 strikethrough+arrow, #8 arrows, #3 scene) with
preserve_overlays ON and confirm the coloured graphics still transfer and no junk
is added. Auto path (no saved edits). Emits a small montage. Removed after.
"""
...
VIDS = ["LJ54oRIM-ZI", "-hjuxRDqBmc", "JzqDV91AFPo"]   # #0, #8, #3
